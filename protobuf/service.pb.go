...
func init() {
	proto.RegisterType((*Empty)(nil), "orchestrator_grpc.Empty")
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0xcb, 0x4c, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0xcc, 0x2f, 0x4a, 0xce, 0x48,
	0x2d, 0x2e, 0x29, 0x4a, 0x2c, 0xc9, 0x2f, 0x8a, 0x4f, 0x2f, 0x2a, 0x48, 0x56, 0x62, 0xe7, 0x62,
	...
	0x89, 0x21, 0x89, 0x0d, 0x6c, 0x97, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xf8, 0x2e, 0x7d, 0xf4,
	0x7c, 0x00, 0x00, 0x00,
}
...
func (c *serviceClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/orchestrator_grpc.Service/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/orchestrator_grpc.Service/Ping",
	}
...
var _Service_serviceDesc = grpc.ServiceDesc{
	ServiceName: "orchestrator_grpc.Service",
