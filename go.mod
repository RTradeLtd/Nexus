module github.com/RTradeLtd/ipfs-orchestrator
...
require (
	...
	github.com/RTradeLtd/database v1.0.8-0.20181130234800-f972da481bb4
	github.com/RTradeLtd/grpc v0.0.0-20181114192314-a01354496a0c
